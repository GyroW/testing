...
def 	debug(code):
		...
		print(code,	"0x00",	 	readSPI(code,	0x00))
		print(code,	"0x01",		readSPI(code,	0x01))
		print(code,	"0x02",		readSPI(code,	0x02))
		print(code,	"0x03",		readSPI(code,	0x03))
		print(code,	"0x04",		readSPI(code,	0x04))
       		print(code,	"0x05",		readSPI(code,	0x05))
       		print(code,	"0x06",		readSPI(code,	0x06))
       		print(code,	"0x07",		readSPI(code,	0x07))
		print(code,	"0x08",		readSPI(code,	0x08))
		print(code,	"0x09",		readSPI(code,	0x09))
		print(code,	"0x0A",		readSPI(code,	0x0A))
		print(code,	"0x10",		readSPI(code,	0x10))
		print(code,	"0x11",		readSPI(code,	0x11))
       		print(code,	"0x12",		readSPI(code,	0x12))
       		print(code,	"0x13",		readSPI(code,	0x13))
       		print(code,	"0x14",		readSPI(code,	0x14))
		print(code,	"0x15",		readSPI(code,	0x15))
		print(code,	"0x16",		readSPI(code,	0x16))
		print(code,	"0x17",		readSPI(code,	0x17))
		print(code,	"0x18",		readSPI(code,	0x18))
		print(code,	"0x19",		readSPI(code,	0x19))
       		print(code,	"0x1A",		readSPI(code,	0x1A))
