...
def 	debug():
	...
	print("0x00", readSPI(0x40,	0x00))
	print("0x01", readSPI(0x40,	0x01))
	print("0x02", readSPI(0x40,	0x02))
	print("0x03", readSPI(0x40,	0x03))
	print("0x04", readSPI(0x40,	0x04))
       	print("0x05", readSPI(0x40,	0x05))
       	print("0x06", readSPI(0x40,	0x06))
       	print("0x07", readSPI(0x40,	0x07))
	print("0x08", readSPI(0x40,	0x08))
	print("0x09", readSPI(0x40,	0x09))
	print("0x0A", readSPI(0x40,	0x0A))
	print("0x10", readSPI(0x40,	0x10))
	print("0x11", readSPI(0x40,	0x11))
       	print("0x12", readSPI(0x40,	0x12))
       	print("0x13", readSPI(0x40,	0x13))
       	print("0x14", readSPI(0x40,	0x14))
	print("0x15", readSPI(0x40,	0x15))
	print("0x16", readSPI(0x40,	0x16))
	print("0x17", readSPI(0x40,	0x17))
	print("0x18", readSPI(0x40,	0x18))
	print("0x19", readSPI(0x40,	0x19))
       	print("0x1A", readSPI(0x40,	0x1A))
